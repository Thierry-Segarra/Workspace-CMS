...
'<p>taille du text</p>'.
'<input name="op_taille" id="op_taille" type="text" placeholder="13 par defaut" value="">px'.

'<p>taille de la box</p>'.
'<label for="op_taille_width">Largeur</label>'.'<br>'.
'<input name="op_taille_width" id="op_taille_width" type="text" placeholder="45 par defaut" value="">px'.'<br>'.
'<label for="op_taille_height">Hauteur</label>'.'<br>'.
'<input name="op_taille_height" id="op_taille_height" type="text" placeholder="21 par defaut" value="">px'.'<br>'.
...
'<input name="op_padding_haut" id="op_padding_haut" type="text" placeholder="1 par defaut" value="">'.'<br>'.
'<label for="op_padding_droit">Droit</label>'.'<br>'.
'<input name="op_padding_droit" id="op_padding_droit" type="text" placeholder="5 par defaut" value="">'.'<br>'.
'<label for="op_padding_bas">Bas</label>'.'<br>'.
'<input name="op_padding_bas" id="op_padding_bas" type="text" placeholder="1 par defaut" value="">'.'<br>'.
'<label for="op_padding_gauche">Gauhe</label>'.'<br>'.
'<input name="op_padding_gauche" id="op_padding_gauche" type="text" placeholder="6 par defaut" value="">';
?>