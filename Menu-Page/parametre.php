...
'<div>'.
    '<button class="categorie_media" onclick="parametre_categorie_cate_pag_art()">CATEGORIE</button>'. // catégorie de la parametre CATEROGIE pour la page et les article
