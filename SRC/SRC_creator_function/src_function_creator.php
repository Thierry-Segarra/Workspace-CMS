<script>
    ...
    <?php include("../SRC/SRC_creator_function/modification_article_html.php") ?> // permet d'afficher l'HTML de l'article
    // Initialise une affiche par defaut
    
</script>

<!--  Partie Modification d'un article -->
<script type="text/javascript" src="../SRC/SRC_creator_function/modification_table.js"></script><!--  Pour modifier un l'article -->
...
<script type="text/javascript" src="../SRC/SRC_creator_function/composans/video.js"></script> <!-- Pour crée une vidéo -->
...
<script type="text/javascript" src="../SRC/SRC_creator_function/composans/html.js"></script> <!-- Pour crée une html -->
...
<script type="text/javascript" src="../SRC/SRC_creator_function/traitement_ligneliste.js"></script> <!-- Permet de traiter l'HTML de l'article pour récuperer les ligne de la liste a modifer -->
...
<?php
    ...
    ?>
        <script type="text/javascript" src="../SRC/SRC_creator_function/enregistrement_modification.js"></script> <!-- Pour enregistrer la structure et l'article -->
        <?php    
    }else{
        ?>
        <script type="text/javascript" src="../SRC/SRC_creator_function/enregistrement.js"></script> <!-- Pour enregistrer la structure et l'article -->
        <?php 
    }
?>

<script type="text/javascript" src="../SRC/SRC_creator_function/quitter.js"></script> <!-- Pour quitter l'article snas sauvegarder -->
