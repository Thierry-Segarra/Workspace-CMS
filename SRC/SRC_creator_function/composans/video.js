function addVideoDiv(i){
   ...
   // compo = le numerot du composan
    ...
    //console.log(divcomp);
    let add = '<div id="div'+i+'comp'+compo+'"><iframe id="viddiv'+i+compo+'" src="" style="background-color: rgb(219, 219, 219);" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>';
