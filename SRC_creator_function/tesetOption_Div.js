function option_div(divnb){
    ...
    if(parcour_menu == 2){
        ...
        if(document.getElementById('idiv'+divnb).style.borderTopLeftRadius){
            ...
            borderTopLeftRadiusV = borderTopLeftRadiusV.substring(borderTopLeftRadius.search('%'),0); // On recupere la valeur pour axe vertical
        ...
        if(document.getElementById('idiv'+divnb).style.borderTopRightRadius){
            ...
            borderTopRightRadiusV = borderTopRightRadiusV.substring(borderTopRightRadius.search('%'),0); // On recupere la valeur pour axe vertical
        ...
        if(document.getElementById('idiv'+divnb).style.borderBottomLeftRadius){
            ...
            borderBottomLeftRadiusV = borderBottomLeftRadiusV.substring(borderBottomLeftRadius.search('%'),0); // On recupere la valeur pour axe vertical
        ...
        if(document.getElementById('idiv'+divnb).style.borderBottomRightRadius){
            ...
            borderBottomRightRadiusV = borderBottomRightRadiusV.substring(borderBottomRightRadius.search('%'),0); // On recupere la valeur pour axe vertical
...
function op_update_div(divnb){ // modifier pour chaque composant car il y a un risque de conflie de fonction    
    ...
    if(parcour_menu == 2){ // Module Bordure
        ...
        if(document.getElementById('op_bordure').value || document.getElementById('op_bordure_haut').value || document.getElementById('op_bordure_droit').value || document.getElementById('op_bordure_bas').value || document.getElementById('op_bordure_gauche').value){
            ...
            document.getElementById('idiv'+divnb).style.borderTopLeftRadius = document.getElementById('op_bordure_hg_h').value+'%'+document.getElementById('op_bordure_hg_v').value+'%';
        }else{document.getElementById('idiv'+divnb).style.borderTopLeftRadius = null}
        
        if(document.getElementById('op_bordure').value || document.getElementById('op_bordure_haut').value || document.getElementById('op_bordure_droit').value || document.getElementById('op_bordure_bas').value || document.getElementById('op_bordure_gauche').value){
            
            document.getElementById('idiv'+divnb).style.borderTopRightRadius = document.getElementById('op_bordure_hd_h').value+'%'+document.getElementById('op_bordure_hd_v').value+'%';
        }else{document.getElementById('idiv'+divnb).style.borderTopRightRadius = null}
        
        if(document.getElementById('op_bordure').value || document.getElementById('op_bordure_haut').value || document.getElementById('op_bordure_droit').value || document.getElementById('op_bordure_bas').value || document.getElementById('op_bordure_gauche').value){
            
            document.getElementById('idiv'+divnb).style.borderBottomLeftRadius = document.getElementById('op_bordure_bg_h').value+'%'+document.getElementById('op_bordure_bg_v').value+'%';
        }else{document.getElementById('idiv'+divnb).style.borderBottomLeftRadius = null}
        
        if(document.getElementById('op_bordure').value || document.getElementById('op_bordure_haut').value || document.getElementById('op_bordure_droit').value || document.getElementById('op_bordure_bas').value || document.getElementById('op_bordure_gauche').value){
            
            document.getElementById('idiv'+divnb).style.borderBottomRightRadius = document.getElementById('op_bordure_bd_h').value+'%'+document.getElementById('op_bordure_bd_v').value+'%';
