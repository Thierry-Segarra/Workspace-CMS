function addMapDiv(i){
    ...
    // compo = le numerot du composan
     ...
     console.log(divcomp);
     let add = '<div id="div'+i+'comp'+compo+'"><iframe id="mapdiv'+i+compo+'"width="100%" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=france+(france)&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></div>';
