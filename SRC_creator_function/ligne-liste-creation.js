function addLigneListe(i,nbcomp){
    ...
    console.log(divcomp);
     ...
     document.getElementById('list_composans').innerHTML =  document.getElementById('list_composans').innerHTML + '<button id="id_op'+i+compo+'" onclick="clearInterval(inter),option_ligne_liste('+i+compo+')">option</button>'+'<button id="id_sup'+i+compo+'" onclick="clearInterval(inter),suprime_ligne_liste('+i+compo+')">suprimer</button><button id="up'+i+compo+'" onclick="up_comp('+i+')">up</button><button id="down'+i+compo+'" onclick="down_comp('+i+')">down</button><br id="id_br'+i+compo+'"><p id="trai_lignelistdiv'+i+compo+'">Nouvelle ellement</p>';
