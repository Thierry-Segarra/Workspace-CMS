<script>
    ...
    function media_categorie_Image(){
        categorie_media = 0;
        document.getElementById("upload_media_liste").innerHTML= `<?php include("./Fonction-Requet/upload_image.php")?>`; // Form pour upload un/des images
        document.getElementById("affiche_media_liste").innerHTML= `<?php include("./Fonction-Requet/media_image.php") ?>`; // Affiche toute les images
    }
    function media_categorie_Video(){
        categorie_media = 1;
        document.getElementById("upload_media_liste").innerHTML= `<?php include("./Fonction-Requet/upload_video.php")?>`; // Form pour upload un vidéo
        document.getElementById("affiche_media_liste").innerHTML= `<?php include("./Fonction-Requet/media_video.php") ?>`; // Affiche toute les vidéo
    }
    function media_categorie_Doc(){
        categorie_media = 2;
        document.getElementById("upload_media_liste").innerHTML= `<?php include("./Fonction-Requet/upload_doc.php")?>`; // Form pour upload un/des document
        document.getElementById("affiche_media_liste").innerHTML= `<?php include("./Fonction-Requet/media_doc.php") ?>`; // Affiche tout les documents
    }
