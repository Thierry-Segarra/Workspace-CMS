...
if (isset($_FILES['monfichier'])) {
    ...
    for ($i = 0; $i < $fileCount; $i++) {
        ...
        if (!(in_array($extensionFichier, $extensionsAutorisees))) {
            ...
            $repertoireDestination = "../Document"."/";
            ...
            if ($taille_fichier < $taille_max){
                ...
                $requete1 = "INSERT INTO `media`(`nom`,`type`,`date`) VALUES ('".$date.$nomDestination."','DOCUMENT','".$date."')";
                ...
                header('location:../index.php?media=2'); // redirige vers la page media
